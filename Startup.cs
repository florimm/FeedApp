...
namespace FeedApp
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<FeedDbContext>(builder => {
            ...
            {
                options.AddScheduledTask<FeedFetcherService>(
                    runAt: utcNow =>
                    {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            if (env.IsDevelopment())
            {
                ...
                {
                    var context = serviceScope.ServiceProvider.GetService<FeedDbContext>();
                    context.Database.Migrate();
                    DataImporter.EnsureFeedSourceData(context);
                }
            }
            else
            {
